...
class CreateResourceDefinition(ResourceDefinitionsCommand, show.ShowOne):

    def get_parser(self, *args, **kwargs):
        parser = super(CreateResourceDefinition, self).get_parser(
            *args, **kwargs)
        parser.add_argument(
            '-n', '--name',
            dest='name',
...
class UpdateResourceDefinition(CreateResourceDefinition,
                               base.BaseOneCommand):
    ...
    def take_action(self, parsed_args):
        ...
        if (parsed_args.content is not None
                or parsed_args.format is not None):
