...
Revision ID: 2df74ddf3979
Revises: 9ae15c85fa92
Create Date: 2016-08-09 18:02:56.737688

"""

# revision identifiers, used by Alembic.
revision = '2df74ddf3979'
...
def upgrade():
    ...
    op.drop_constraint(
        ...
        table_prefix + 'resource_values', type='foreignkey')
    op.create_foreign_key(
        table_prefix + 'environment_resource_values_environment_id_fkey',
