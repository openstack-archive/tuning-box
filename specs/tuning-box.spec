...
%install
cd %{_builddir}/%{name}-%{version} && export PBR_VERSION=%{version} && %{__python} setup.py install --single-version-externally-managed -O1 --root=$RPM_BUILD_ROOT && unset PBR_VERSION
